        ...
        return (
            <div>
                ...
                <div className='card-containter'>
                    <CardList className='card' topic='Programming Languages' info='Java, Python, SQL, JavaScript, C, C#, VB.NET, HTML, CSS, Functional Programming'/>
                    ...
                    <CardList className='card' topic='Job Interest' info='Software Engineer, Business Analyst, Data Analyst'/>
