        ...
        return (
            <div>
                ...
                <div className='card-containter'>
                    <CardList className='card' topic='Programming Languages' info='Java, Python, JavaScript, C, C#, VB.NET, SQL, HTML, CSS, Functional Programming'/>
                    <CardList className='card' topic='Technical Skills' info='React, Git, BitBucket, Jira, Jenkins, Flask, macOS, Linux, Node.js, NPM, GitHub, Jest, MySQL, SQLite, Oracle Database, Microsoft SQL Server Express, Bash'/>
                    ...
                    <CardList className='card' topic='Job Interest' info='Software Engineer, Data Engineer, Data Scientist, Data Analyst'/>
